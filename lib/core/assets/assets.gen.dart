...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/Cyber shield protecting digital data with strong password.png
  AssetGenImage get cyberShieldProtectingDigitalDataWithStrongPassword =>
      const AssetGenImage(
          'assets/images/Cyber shield protecting digital data with strong password.png');

  /// File path: assets/images/Cybersecurity with password protection.png
  AssetGenImage get cybersecurityWithPasswordProtection => const AssetGenImage(
      'assets/images/Cybersecurity with password protection.png');

  /// File path: assets/images/Digital shopping and online payment.png
  ...
  AssetGenImage get darkTopWave =>
      const AssetGenImage('assets/images/darkTopWave.png');

  /// File path: assets/images/darkbottomsplash.svg
  String get darkbottomsplash => 'assets/images/darkbottomsplash.svg';

  /// File path: assets/images/darksplash.svg
  String get darksplash => 'assets/images/darksplash.svg';

  /// File path: assets/images/data security.png
