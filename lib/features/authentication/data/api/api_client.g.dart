...
class _AuthApiClient implements AuthApiClient {
  ...
  Future<RegisterResponse> register(
      {required RegisterRequestBody registerRequest}) async {
  ...
  @override
  Future<String> sendOTP({required Map<String, dynamic> email}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> verifyOTP({required VerifyOTPBody verifyOTPBody}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyOTPBody.toJson());
  ...
  Future<String> verifyAccount(
      {required Map<String, dynamic> verifyAccountBody}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyAccountBody);
    final _options = _setStreamType<String>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<void> newPassword({required NewPasswordRequestBody body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
