...
class _HomeApiClient implements HomeApiClient {
  ...
  @override
  Future<List<GetAllCategoryResponse>> getAllCategory() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetAllCategoryResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<GetAllCategoryResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  @override
  Future<GetCompanies> getCompanies() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetCompanies>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late GetCompanies _value;
    try {
      _value = GetCompanies.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
