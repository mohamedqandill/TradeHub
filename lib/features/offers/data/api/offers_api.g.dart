...
class _OffersApiClient implements OffersApiClient {
  ...
  @override
  Future<OfferResponse> getOfferDetails(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> addOfferToCart(
      {required AddOfferRequestBody addOfferRequestBody}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addOfferRequestBody.toJson());
